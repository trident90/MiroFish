    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        ...
        <div class="card-content">
          <p class="api-note">{{ t('step2.simInstanceApiNote') }}</p>
          <p class="description">
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('step2.generatePersonas') }}</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 1" class="badge success">{{ t('status.completed') }}</span>
            <span v-else-if="phase === 1" class="badge processing">{{ prepareProgress }}%</span>
            <span v-else class="badge pending">{{ t('status.waiting') }}</span>
          </div>
        </div>

        <div class="card-content">
          <p class="api-note">{{ t('step2.generatePersonasApiNote') }}</p>
          <p class="description">
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">{{ t('step2.expectedTotal') }}</span>
            </div>
            <div class="stat-card">
                  ...
                  <div class="agent-params">
                    <div class="param-group">
                      <div class="param-item">
                        <span class="param-label">{{ t('step2.postsPerHr') }}</span>
                        <span class="param-value">{{ agent.posts_per_hour }}</span>
                      </div>
                      <div class="param-item">
                        <span class="param-label">{{ t('step2.commentsPerHr') }}</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        <div class="card-header">
          ...
          <div class="step-status">
            ...
            <span v-else-if="phase === 3" class="badge processing">{{ t('status.orchestrating') }}</span>
            <span v-else class="badge pending">{{ t('status.waiting') }}</span>
          </div>
        </div>
        ...
        <div class="card-content">
          ...
          <div v-if="simulationConfig?.event_config" class="orchestration-content">
            ...
            <div class="topics-section">
              <span class="box-label">{{ t('step2.initialTrending') }}</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <!-- Simulation rounds config - only show when config generation is complete and rounds are calculated -->
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                <span class="section-title">{{ t('step2.roundSettings') }}</span>
                <span class="section-desc">{{ t('step2.roundSettingsDesc').replace('{hours}', simulationConfig?.time_config?.total_simulation_hours || '-').replace('{minutes}', simulationConfig?.time_config?.minutes_per_round || '-') }}</span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>{{ t('step2.estimatedDuration').replace('{minutes}', Math.round(customMaxRounds * 0.6)) }}</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        {{ t('step2.estimatedDuration').replace('{minutes}', Math.round(autoGeneratedRounds * 0.6)) }}
                      </span>
                    </div>
                    <div class="auto-desc">
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            <div class="info-item">
              <span class="info-label">{{ t('step2.profileModal.apparentAge') }}</span>
              <span class="info-value">{{ selectedProfile.age || '-' }} yrs</span>
            </div>
            <div class="info-item">
              <span class="info-label">{{ t('step2.profileModal.apparentGender') }}</span>
              <span class="info-value">{{ { male: t('step2.profileModal.male'), female: t('step2.profileModal.female'), other: t('step2.profileModal.other') }[selectedProfile.gender] || selectedProfile.gender }}</span>
            </div>
            <div class="info-item">
              <span class="info-label">{{ t('step2.profileModal.countryRegion') }}</span>
              <span class="info-value">{{ selectedProfile.country || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="info-label">{{ t('step2.profileModal.apparentMBTI') }}</span>
          ...
          <div class="modal-section">
            <span class="section-label">{{ t('step2.profileModal.personaBio') }}</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            <span class="section-label">{{ t('step2.profileModal.detailedPersona') }}</span>
