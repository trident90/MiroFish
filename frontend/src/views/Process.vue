  ...
  <div class="process-page">
    ...
    <nav class="navbar">
      ...
      <div class="nav-center">
        <div class="step-badge">{{ t('nav.stepBadge') }}</div>
        <div class="step-name">{{ t('step.graphConstruction') }}</div>
      </div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, the LLM analyzes document content and automatically generates an ontology structure (entity types + relation types) suitable for public opinion simulation.
                </div>
              </div>
...
const handleNewProject = async () => {
  ...
  if (!pending.isPending || pending.files.length === 0) {
    error.value = 'No pending files to upload, please return to homepage and try again'
    loading.value = false
    return
  }
