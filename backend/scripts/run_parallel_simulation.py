...
# This fixes encoding issues when OASIS third-party libraries read files without specifying encoding
# ============================================================
import sys
import os
...
if sys.platform == 'win32':
    ...
    # Note: This needs to be set at Python startup; runtime settings may not take effect
...
def fetch_new_actions_from_db(
    ...
    """
    Fetch new action records from database with complete context information

    Args:
        db_path: Database file path
        last_rowid: Last read maximum rowid value (using rowid instead of created_at because different platforms have different created_at formats)
...
async def main():
    ...
    if args.twitter_only:
        ...
        # Run in parallel (each platform uses independent loggers)
