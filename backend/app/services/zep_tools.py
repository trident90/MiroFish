...
class ZepToolsService:
    ...
    def llm(self) -> LLMClient:
        ...
        if self._llm_client is None:
            self._llm_client = LLMClient(role="simulation")
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        """
        Get all edges from graph (with pagination, including time info)
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Returns:
            Edge list
        """
        logger.info(f"Getting node {node_uuid[:8]}... related edges")
    ...
    def get_entity_summary(
        ...
        Search for all information related to this entity and generate summary
        ...
        """
        logger.info(f"Getting entity {entity_name} relationship summary...")
    ...
    def get_graph_statistics(self, graph_id: str) -> Dict[str, Any]:
        ...
        """
        logger.info(f"Fetching graph {graph_id} statistics...")
        ...
        # Relationship type distribution statistics
        relation_types = {}
        for edge in edges:
...
4. Return in JSON format: {"sub_queries": ["sub_question_1", "sub_question_2", ...]}"""
...
Return the sub-question list in JSON format."""
    ...
    def panorama_search(
        ...
        This tool is suitable for scenarios requiring understanding the full picture of events and tracking evolution.
    ...
    def interview_agents(
        ...
        try:
            ...
            logger.info(f"Calling batch interview API (dual-platform): {len(interviews_request)} Agent")
    ...
    def _clean_tool_call_response(response: str) -> str:
        """Clean JSON tool call wrapper from Agent reply, extract actual content"""
...
Please select up to {max_agents} most suitable Agents for interviewing, and explain the selection reasoning."""
