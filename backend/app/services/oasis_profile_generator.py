...
1. Call Zep retrieval functions to further enrich node information
...
class OasisProfileGenerator:
    ...
    1. Call Zep graph retrieval functions to obtain richer context
    ...
    def _is_individual_entity(self, entity_type: str) -> bool:
        """Determine whether it is an individual entity type"""
        return entity_type.lower() in self.INDIVIDUAL_ENTITY_TYPES
    
    def _is_group_entity(self, entity_type: str) -> bool:
        """Determine whether it is a group/institution entity type"""
    ...
    def _build_individual_persona_prompt(
        ...
        return f"""Generate a detailed social media user persona for the entity, restoring the existing real-world situation to the greatest extent possible.
...
2. persona: Detailed persona description (2000 characters of plain text), must include:
   ...
   - Stances and viewpoints (attitudes toward topics, content that may provoke anger/emotion)
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate a detailed social media account profile for an institution/group entity, restoring the existing real-world situation to the greatest extent possible.
